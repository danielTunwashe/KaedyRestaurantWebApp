...
namespace KaedyRestaurant.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        //Specify our tables in the db context files
        ...
        protected override void OnModelCreating(ModelBuilder ModelBuilder)
        {
            ...
            //Define Compsite Key and relationship for product ingredients
            ...
            ModelBuilder.Entity<Product>().HasData(
                ...
                new Product
                {
                    ProductId = 2,
                    Name = "Chicken Taco",
                    Description = "A delicious checken taco",
                    Price = 2.50m,
                    stock = 101,
                    CategoryId = 2
                },
